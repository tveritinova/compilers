...
parser: parser.o lex.o visitor.o
	g++ -o parser visitor.o lex.o parser.o 

parser.o:  bison_code
	bison -dt --verbose bison_code && mv bison_code.tab.h tokens.h && mv bison_code.tab.c parser.cpp && g++ -c --std=c++11 parser.cpp -o parser.o
